 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.aem__002d__bootcamp__002d__ui.components.structure.imagetext;
...
_global_clientlib = renderContext.call("use", "/libs/granite/sightly/templates/clientlib.html", obj());
{
    ...
    {
        String var_templateoptions1_field$_categories = "imagetext.content";
        {
...
{
    Object var_8 = renderContext.call("xss", renderContext.getObjectModel().resolveProperty(_dynamic_properties, "pretitle"), "text");
    out.write(renderContext.getObjectModel().toString(var_8));
}
out.write("</h5>\r\n        <h2>");
{
    Object var_9 = renderContext.call("xss", renderContext.getObjectModel().resolveProperty(_dynamic_properties, "jcr:title"), "text");
    out.write(renderContext.getObjectModel().toString(var_9));
}
out.write("</h2>\r\n        <p>");
{
    Object var_10 = renderContext.call("xss", renderContext.getObjectModel().resolveProperty(_dynamic_properties, "jcr:description"), "html");
    out.write(renderContext.getObjectModel().toString(var_10));
}
out.write("</p>\r\n        <a class=\"read-more\"");
{
    Object var_attrvalue11 = renderContext.call("uriManipulation", renderContext.getObjectModel().resolveProperty(_dynamic_properties, "linkURL"), obj().with("extension", "html"));
    {
