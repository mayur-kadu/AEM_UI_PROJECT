 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.aem__002d__bootcamp__002d__ui.components.structure.card;
...
_global_clientlib = renderContext.call("use", "/libs/granite/sightly/templates/clientlib.html", obj());
{
    ...
    {
        String var_templateoptions1_field$_categories = "card.content";
        {
...
out.write("/>\n    </div>\n    <div class=\"card-text\">\n        <h2>");
{
    Object var_8 = renderContext.call("xss", renderContext.getObjectModel().resolveProperty(_dynamic_properties, "jcr:title"), "text");
    out.write(renderContext.getObjectModel().toString(var_8));
}
out.write("</h2>\n        <p>");
{
    Object var_9 = renderContext.call("xss", renderContext.getObjectModel().resolveProperty(_dynamic_properties, "jcr:description"), "html");
    out.write(renderContext.getObjectModel().toString(var_9));
}
out.write("</p>\n");
{
    String var_10 = (("<!--        <a href=\"" + renderContext.getObjectModel().toString(renderContext.call("xss", renderContext.getObjectModel().resolveProperty(_dynamic_properties, "linkURL"), "comment"))) + "\" class=\"sec-button\">Read more</a>-->");
