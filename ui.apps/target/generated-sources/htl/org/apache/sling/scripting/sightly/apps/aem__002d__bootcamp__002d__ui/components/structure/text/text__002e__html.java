 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.aem__002d__bootcamp__002d__ui.components.structure.text;
...
_global_clientlib = renderContext.call("use", "/libs/granite/sightly/templates/clientlib.html", obj());
{
    ...
    {
        String var_templateoptions1_field$_categories = "text.content";
        {
...
out.write("\n\n");
_global_empty = (!renderContext.getObjectModel().toBoolean(renderContext.getObjectModel().resolveProperty(_dynamic_properties, "text")));
...
_global_template = renderContext.call("use", "core/wcm/components/commons/v1/templates.html", obj());
    {
        ...
        {
            Object var_templateoptions5_field$_isempty = _global_empty;
            {
...
out.write("\n<div class=\"ui-text\">\n<p>");
{
    Object var_6 = renderContext.call("xss", renderContext.getObjectModel().resolveProperty(_dynamic_properties, "text"), "html");
